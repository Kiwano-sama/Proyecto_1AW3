    ...
    <div class="registro-login">
        ...
        <form action="" method="get">
            <fieldset>
                ...
                <p> <input class="inputespecial" type="text" placeholder="Email o Usuario" name="nombre" value=""/></p>
                <p>Contraseña:</p>
                <p><input class="inputespecial" type="password" name="password"  placeholder="contraseña" value="" maxlength="15" /></p>
